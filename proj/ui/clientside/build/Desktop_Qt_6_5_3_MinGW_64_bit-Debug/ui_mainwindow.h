...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout->addWidget(createProjectButton);
        ...
        joinProjectButton = new QPushButton(centralwidget);
        joinProjectButton->setObjectName("joinProjectButton");

        horizontalLayout->addWidget(joinProjectButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ipAddressLabel->setText(QString());
        joinProjectButton->setText(QCoreApplication::translate("MainWindow", "Join Project", nullptr));
    } // retranslateUi
