...
void MainWindow::openWindow1() {
    ...
    QLabel *label1 = new QLabel("Здесь будет окно запуска нового проекта");
    ...
    // Настройка окна
    window1->setWindowTitle("Новый проект");
...
void MainWindow::openWindow2() {
    ...
    // Создание виджета для отображения текста
    QLabel *label2 = new QLabel("Здесь будет окно подключения к существующему проекту");
    ...
    // Настройка окна
    window2->setWindowTitle("Подключение к существующему проекту");
